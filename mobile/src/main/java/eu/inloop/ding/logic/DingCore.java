...
public final class DingCore {
    ...
    public void addAudioListener(AudioBufferListener listener) {
        mChirpSDK.addAudioBufferListener(listener);
    }

    public void removeAudioListener(AudioBufferListener listener) {
        mChirpSDK.removeAudioBufferListener(listener);
    }
